		...
		<AboutWrapper>
			<div className='container mx-auto lg:mt-[50px] mt-[20px] px-[20px] lg:px-0'>
				...
				<div className=' hidden lg:grid grid-rows-2 grid-flow-col gap-[30px]'>
					<div className='row-span-2 col-span-2'>
						<img className='h-full w-full' src={"./images/about/about-1.png"} alt={"image"} />
					</div>
					<div className='row-span-1 '>
						<img className='h-full w-full' src={"./images/about/about-2.png"} alt={"image"} />
					</div>
					<div className='row-span-1  '>
						<img className='h-full w-full' src={"./images/about/about-3.png"} alt={"image"} />
					</div>
				</div>
				...
				<div className='grid lg:grid-cols-3 grid-cols-1 gap-[30px] lg:mt-[40px] mt-[20px]'>
					<div className='item'>
						<div className='title uppercase border-l-2 border-primary px-[10px] mb-[20px]'>CHIẾN LƯỢC</div>
						<div className="content" dangerouslySetInnerHTML={{__html:props.dataHome?.about?.chienluoc}}>
					...
					<div className='item'>
						<div className='title uppercase border-l-2 border-primary px-[10px] mb-[20px]'>ĐỊNH HƯỚNG</div>
						<div className="content" dangerouslySetInnerHTML={{__html:props.dataHome?.about?.dinhhuong}}>
					...
					<div className='item'>
						<div className='title uppercase border-l-2 border-primary px-[10px] mb-[20px]'>LIÊN HỆ</div>
						...
						{/*</a>*/}
						<div className="content" dangerouslySetInnerHTML={{__html:props.dataHome?.about?.lienhe}}>
			...
			<div className='kham-pha md:py-[50px] py-[20px] md:mt-[50px] mt-[20px]'>
				<div className='container mx-auto flex flex-col lg:flex-row justify-between items-center'>
					<div className='dicover mb-[20px] lg:mb-0'>{props.dataHome?.khamPha?.title?.toUpperCase()}</div>
					<div className='flex flex-col items-center mb-[20px] lg:mb-0'>
						<div className='count mb-[20px]'>{props.dataHome?.khamPha?.duLieu?.[0]?.soLuong} +</div>
						<div className='des'>{props.dataHome?.khamPha?.duLieu?.[0]?.title?.toUpperCase()}</div>
					</div>
					<div className='flex flex-col items-center'>
						<div className='count mb-[20px]'>{props.dataHome?.khamPha?.duLieu?.[1]?.soLuong} +</div>
						<div className='des'>{props.dataHome?.khamPha?.duLieu?.[1]?.title?.toUpperCase()}</div>
					</div>
				</div>
			</div>
		</AboutWrapper>
