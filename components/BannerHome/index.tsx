...
import BannerhomeSkeleton from "../Skeleton/BannerhomeSkeleton";

const BannerHome = (props: { dataHome: IDataHome; loading?: boolean }) => {
  ...
  return (
    <BannerWrapper>
      <div className="relative">
        ...
        {props?.loading ? (
          <BannerhomeSkeleton></BannerhomeSkeleton>
        ) : (
