	...
	return (
		<CardNghienCuuWrapper>
			<div className='flex hover:border-none border-b border-primary py-[40px] px-[20px] justify-between cursor-pointer'>
				<div className='flex'>
					<div className='no-number text-primary shrink-0 mr-[28px]'>{data.no}</div>
					<div className=' text-primary title mr-[70px]'>{data.title}</div>
				</div>
...
const CardNghienCuuWrapper = styled.div`
  &:hover{
    background: linear-gradient(0deg, rgba(20, 33, 65, 0.06), rgba(20, 33, 65, 0.06)), #FFFFFF;
