...
const Nganhnoibat = () => {
  // Dữ liệu fake cho các ngành nghề nổi bật
  const featuredFields = [
    {
      id: 1,
      icon: '/images/home/CNTT.gif',
    ...
    {
      id: 2,
      icon: '/images/home/ITphanmem.gif',
      title: 'IT Phần mềm',
      jobCount: 4,
      link: '/nganh/it-phan-mem',
    },
    {
      id: 3,
      icon: '/images/home/Marketing.gif',
      title: 'Marketing',
      jobCount: 1,
      link: '/nganh/marketing',
    },
    {
      id: 4,
      icon: '/images/home/Truyenthong.gif',
      title: 'Truyền thông',
      jobCount: 2,
      link: '/nganh/truyen-thong',
    },
    {
      id: 5,
      icon: '/images/home/Kinh doanh.gif',
      title: 'Kinh doanh',
      jobCount: 3,
      link: '/nganh/kinh-doanh',
    },
    {
      id: 6,
      icon: '/images/home/Quangcao.gif',
      title: 'Quảng cáo',
      jobCount: 3,
      link: '/nganh/quang-cao',
    },
    {
      id: 7,
      icon: '/images/home/sell.gif',
      title: 'Bán hàng',
      jobCount: 3,
      link: '/nganh/ban-hang',
    },
    {
      id: 8,
      icon: '/images/home/Dichvukhachhang.gif',
      title: 'Dịch vụ khách hàng',
      jobCount: 2,
      link: '/nganh/dich-vu-khach-hang',
    },
  ];
      ...
      <div className="container">
        <div className="header">
          <div className="title-section">
            ...
            <p>Tổng hợp những ngành nghề nổi bật trong hệ sinh thái Jobs PTIT</p>
          </div>
