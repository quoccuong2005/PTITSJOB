                ...
                <div className="lg:mx-auto px-[16px] lg:px-[40px] py-[16px]">
                    <div className={`hidden lg:flex justify-between items-center relative`}>
                        <div className="flex items-center gap-[20px]">
                            ...
                            <a href="#" onClick={(e) => {
                                e.preventDefault();
                                const el = document.getElementById("lydo");
                                if (el) el.scrollIntoView({ behavior: "smooth" });
                            }} className="flex items-center gap-1 px-2 py-1 font-semibold text-[#051A53] hover:text-[#d32f2f] bg-transparent border-none outline-none cursor-pointer">Lý do</a>
                            <a onClick={(e) => {
                                e.preventDefault();
                                const el = document.getElementById("hinhthuc");
                                if (el) el.scrollIntoView({ behavior: "smooth" });
                            }} className="flex items-center gap-1 px-2 py-1 font-semibold text-[#051A53] hover:text-[#d32f2f] bg-transparent border-none outline-none cursor-pointer">Hình thức</a>
                            <a onClick={(e) => {
                                e.preventDefault();
                                const el = document.getElementById("quytrinh");
                                if (el) el.scrollIntoView({ behavior: "smooth" });
                            }} className="flex items-center gap-1 px-2 py-1 font-semibold text-[#051A53] hover:text-[#d32f2f] bg-transparent border-none outline-none cursor-pointer">Quy trình </a>
                            <a onClick={(e) => {
                                e.preventDefault();
                                const el = document.getElementById("congcu");
                                if (el) el.scrollIntoView({ behavior: "smooth" });
                            }} className="flex items-center gap-1 px-2 py-1 font-semibold text-[#051A53] hover:text-[#d32f2f] bg-transparent border-none outline-none cursor-pointer">Công cụ </a>
                            <a onClick={(e) => {
                                e.preventDefault();
                                const el = document.getElementById("hoptac");
                                if (el) el.scrollIntoView({ behavior: "smooth" });
                            }} className="flex items-center gap-1 px-2 py-1 font-semibold text-[#051A53] hover:text-[#d32f2f] bg-transparent border-none outline-none cursor-pointer">Hợp tác</a>
                            <a onClick={(e) => {
                                e.preventDefault();
                                const el = document.getElementById("tintuc");
                                if (el) el.scrollIntoView({ behavior: "smooth" });
...
`;
export default React.memo(HeaderDoanhNghiep);
