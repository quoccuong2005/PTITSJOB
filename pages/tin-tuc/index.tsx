...
import {DataNew, DataNewList, TypeTinTuc} from "../../utils/interface";
...
const handleGetChiTiet = async () => {
  try {
	...
	const onSubmit = (data: any) => {
		...
		// });
		router.push(`/tin-tuc?keyword=${data?.keyword}${data?.type ? `&type=${data?.type}` : ""}`);
	};
